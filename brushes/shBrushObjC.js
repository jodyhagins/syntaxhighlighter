    ...
    function Brush()
    {
      ...
      var functions =	'assert isalnum isalpha iscntrl isdigit isgraph islower isprint' +
		  ...
		  this.regexList = [
		    ...
		    { regex: /@\\w+\\b/g,                                    css: 'color2 bold' }, // ObjC keyword
		    { regex: /@/g,                                           css: 'string' },      // Most likely NSString
		    { regex: /\.?\\b\\d+[a-z]?\\b/g,                         css: 'constants' },   // Number
		    { regex: /\\b(NS|UI|CG)\\w+\\b/g,                        css: 'color3' },      // Cocoa Prefixes
		    { regex: /\\b(WJH|_WJH|wjh|_wjh)\\w+\\b/g,               css: 'variable' },    // My Prefixes
